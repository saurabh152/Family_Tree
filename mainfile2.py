...
class family_Tree_Node :
    ...
    def __init__(self, name , gender , partner_name = None , partner_gender = None) :
        self.name = name
        self.gender = gender
    ...
    def get_relationship_paternal_uncle(self):
        ...
        if curr_parent.gender == "Male" :
            for child in supr_parent.children :
                if child.gender == "Male" and child.name != curr_parent.name :
    ...
    def get_relationship_paternal_aunt(self):
        ...
        if curr_parent.gender == "Male" :
            for child in supr_parent.children :
                if child.gender == "Female" and child.name != curr_parent.name :
...
#---------use to print the tree ---------#    
    ...
    def print_family_tree(self):
        ...
        if self.partner_name == None :
            ...
            print(prefix + self.name + ' ' + self.gender + ' ++++++++++++++++++ ' + self.partner_name + ' ' + self.partner_gender +"\n" )
...
def make_family_tree() :
    ...
    king_Shan = family_Tree_Node('King_Shan','Male' , 'Queen_Anga' , 'Female' )
...
def add_input_child( family_head , mother_name , child_name , child_gender ) :

    parent = search_member_in_the_tree(family_head, mother_name )

    if parent :

        if (parent.name == mother_name and parent.gender == "Female") or ( parent.partner_name == mother_name and parent.partner_gender == "Female" ) :
...
#--#------ Below block adds_child and gets_relation ------#--#
    ...
    for input_string in input_strings :
        ...
        if(inp == "ADD_CHILD") :
            ...
            add_input_child( family_head , mother_name , child_name , child_gender)
